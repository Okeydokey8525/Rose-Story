...
M\xbb\xa5c tiêu KHÔNG phải chỉ tạo một `README.md`.
...
M\xbb\x8di thông tin phải được ưu tiên xác minh từ:
...
M\xbb\x8di command phải được lấy từ project configuration hoặc xác minh thực tế.
...
M\xbb\xa5c tiêu là giúp AI hiểu:
...
M\xbb\x97i thay đổi quan trọng nên có:
...
M\xb4 tả configuration nhưng KHÔNG ghi secrets.
...
M\xbb\x97i khi có thay đổi quan trọng, file này phải được cập nhật.
...
M\xbb\xa5c tiêu là ghi lại những thay đổi ảnh hưởng đến việc AI tiếp quản project.
...
M\xbb\x97i nhóm thông tin phải có trạng thái:
...
M\xbb\x97i file Markdown nên có metadata ở đầu:
...
M\xbb\x97i thông tin quan trọng phải ưu tiên source of truth.
...
Current task
→ current-state / handoff / issue tracker
```
